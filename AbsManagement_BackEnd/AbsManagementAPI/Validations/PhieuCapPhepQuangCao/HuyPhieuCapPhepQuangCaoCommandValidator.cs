...
namespace AbsManagementAPI.Validations.PhieuCapPhepQuangCao
{
    ...
    public class HuyPhieuCapPhepQuangCaoCommandValidator : AbstractValidator<HuyPhieuCapPhepQuangCaoCommand>
    {
        private readonly DataContext _dataContext;

        public HuyPhieuCapPhepQuangCaoCommandValidator(DataContext dataContext)
        {
