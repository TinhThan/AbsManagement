...
namespace AbsManagementAPI.Validations.PhieuCapPhepQuangCao
{
    ...
    public class DuyetPhieuCapPhepQuangCaoCommandValidator : AbstractValidator<DuyetPhieuCapPhepQuangCaoCommand>
    {
        private readonly DataContext _dataContext;

        public DuyetPhieuCapPhepQuangCaoCommandValidator(DataContext dataContext)
        {
